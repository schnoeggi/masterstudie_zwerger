<template>
  <section class="mt-15 px-3 mb-5 text-center" style="position:relative">
    <p class="text-h6">Nur noch ein paar Fragen...</p>
    <p class="text-body-1">
      Bewerten Sie bitte inwiefern folgende Aussagen auf einer Skala von 1 bis 4 auf Sie persönlich zutreffen.
    </p>
    <div class="ma-auto mb-5 stickli background pt-5">
      <p class="text-center ma-0 pa-0 sticky">1 = stimme überhaupt nicht zu</p>
      <p class="text-center m-0 p-0">4 = stimme völlig zu</p>
...
import questions from "../assets/systemjustification.json";
