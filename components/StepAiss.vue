<template>
  <section class="mt-15 px-3 mb-5 text-center" style="position:relative">
    <p class="text-h6 ">Bewerten Sie folgende Aussagen</p>

    <p class="text-body-1">
      Im Folgenden finden Sie vierzehn Aussagen zur Beschreibung der eigenen Person. Bitte geben Sie bei jeder Aussage
      an, wie sehr diese auf Sie persönlich zutrifft. Hierfür stehen ihnen folgende Antworten zur Verfügung:

    </p>
    <div class="ma-auto mb-5 stickli background pt-5">
      <p class="text-center ma-0 pa-0 sticky">1 = trifft überhaupt nicht auf mich zu</p>
      <p class="text-center ma-0 pa-0">2 = trifft kaum auf mich zu</p>
      <p class="text-center ma-0 pa-0">3 = trifft etwas auf mich zu</p>
      <p class="text-center m-0 p-0">4 = trifft stark auf mich zu</p>
...
import questions from "../assets/aiss.json";
